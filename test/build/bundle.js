(function (QUnit, sinon, videojs) {
	...
	*/
	...
	QUnit.test('the environment is sane', function (assert) {
	  ...
	  assert.strictEqual(typeof httpSourceSelector, 'function', 'plugin is a function');
	});
	...
	QUnit.test('registers itself with video.js', function (assert) {
	  assert.expect(2);
	  assert.strictEqual(typeof Player.prototype.httpSourceSelector, 'function', 'videojs-http-source-selector plugin was registered');
